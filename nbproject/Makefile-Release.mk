...
${OBJECTDIR}/CoupSHOT.o: CoupSHOT.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CoupSHOT.o CoupSHOT.cpp
...
${OBJECTDIR}/SimuSHOT.o: SimuSHOT.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SimuSHOT.o SimuSHOT.cpp
...
${OBJECTDIR}/decision.o: decision.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/decision.o decision.cpp
